...
void SlamGmapping::init() 
{
    ...
    map_update_interval_ = tf2::durationFromSec(declare_parameter("map_update_interval", 1.0));
    ...
    linearUpdate_ = declare_parameter("linearUpdate", 0.2);
    angularUpdate_ = declare_parameter("angularUpdate", 0.2);
    temporalUpdate_ = declare_parameter("temporalUpdate", 0.2);
